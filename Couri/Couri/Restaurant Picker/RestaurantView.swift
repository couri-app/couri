...
extension RestaurantLibrary {
    mutating func generateRestaurantLibrary() {
        let rareTeaBancroft = Restaurant(restaurantName: "RareTea on Bancroft", categoryDescription: "Milk Tea, Smoothies, Snacks", description: "Authentic boba tea shop. Offers a variety of organic milk tea, fresh fruit tea and smoothies.", imageName: #imageLiteral(resourceName: "rareteaBancroft"), categories: ["Popular", "Milk Tea"])
